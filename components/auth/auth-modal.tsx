          ...
          {mode === "sign-in" ? (
            <div className="p-6">
              <SignIn.Root>
                ...
                <Clerk.GlobalError className="text-red-400 text-sm mb-4 p-3 bg-red-50 border border-red-200 rounded-md" />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <Clerk.Connection name="github" asChild>
                        <Button
                          variant="outline"
                          className="bg-wa-input border-wa-border text-wa-primary hover:bg-wa-hover transition-colors flex items-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
